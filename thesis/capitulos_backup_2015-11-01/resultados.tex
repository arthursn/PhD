...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/thermo-calc/NPvsT.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/thermo-calc/CvsT.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[height=7cm]{img/dilatometria/1_fofoTupy_10oCmin_2.pdf}}
	\quad
	\subfloat[]{\includegraphics[height=7cm]{img/dilatometria/1_fofoTupy_10oCmin.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[height=9cm]{img/dilatometria/dil_martensita.pdf}}
	\vspace{0pt}
	\subfloat[]{\includegraphics[height=9cm]{img/dilatometria/dil_martensita_close.pdf}}
...
A fração transformada de martensita a partir da austenita $f^{\alpha\text{\textquoteright}}$ foi calculada utilizando a regra das alavancas, expressa pela equação a seguir:
...
\begin{figure}
	\subfloat[]{\includegraphics[height=9cm]{img/dilatometria/170-300.pdf}}
	\vspace{0pt}
	\subfloat[]{\includegraphics[height=9cm]{img/dilatometria/170-300_close.pdf}}
...
%\begin{figure}
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxtime_PT200.pdf}}
	%\quad
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxT_PT200.pdf}}
...
%
%\begin{figure}
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxtime_PT250.pdf}}
	%\quad
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxT_PT250.pdf}}
...
%
%\begin{figure}
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxtime_PT300.pdf}}
	%\quad
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxT_PT300.pdf}}
...
%
%\begin{figure}
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxtime_PT375.pdf}}
	%\quad
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxT_PT375.pdf}}
...
%
%\begin{figure}
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxtime_PT450.pdf}}
	%\quad
	%\subfloat[]{\includegraphics[width=7.5cm]{img/dilatometria/dilxT_PT450.pdf}}
...
\begin{figure}
	\includegraphics[width=16cm]{img/XTMS/map_TT170TP300.pdf}
...
\begin{figure}
	\includegraphics[width=16cm]{img/XTMS/map_TT170TP300_2.pdf}
...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/f_isoPT200.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/wC_gamma200.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/f_isoPT250.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/wC_gamma250.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/f_isoPT300.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/wC_gamma300.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/f_isoPT375.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/wC_gamma375.pdf}}
...
\begin{figure}
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/f_isoPT450.pdf}}
	\quad
	\subfloat[]{\includegraphics[width=7.5cm]{img/XTMS/wC_gamma450.pdf}}
...
\begin{figure}
	\includegraphics[width=12cm]{img/XTMS/wC_alpha.pdf}
...
\begin{figure}
	\includegraphics[width=12cm]{img/XTMS/finalScan.pdf}
